...
import { exampleBls12381KeyPair, customLoader } from "./__fixtures__";
import { Bls12381G2KeyPair, BbsTermwiseSignatureProof2021 } from "../src/index";
...
const anonToTerm = new Map<string, RDF.NamedNode | RDF.BlankNode | RDF.Literal>(
  [
    ...
    [
      ...
      rdfdf.literal(
        "80000",
        rdfdf.namedNode("http://www.w3.org/2001/XMLSchema#integer")
      )
    ]
  ]
);
...
const inputDocuments = [
  {
    document: document1,
    proofs: proofs1,
    revealedDocument: revealedDocument1,
    anonToTerm
  },
  {
    document: document2,
    proofs: proofs2,
    revealedDocument: revealedDocument2,
    anonToTerm
  }
];
